...
<body>
    ...
    <script src="<c:url value='/backend/vendor/flot/excanvas.min.js'/>"></script>
    <script src="<c:url value='/backend/vendor/flot/jquery.flot.js'/>"></script>
    <script src="<c:url value='/backend/vendor/flot/jquery.flot.pie.js'/>"></script>
    <script src="<c:url value='/backend/vendor/flot/jquery.flot.resize.js'/>"></script>
    <script src="<c:url value='/backend/vendor/flot/jquery.flot.time.js'/>"></script>
    <script src="<c:url value='/backend/vendor/flot-tooltip/jquery.flot.tooltip.min.js'/>"></script>
    <script src="<c:url value='/backend/data/flot-data.js'/>"></script>
